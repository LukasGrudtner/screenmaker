...
public class DisplayPanel extends JPanel {
	...
	public void showDisplay(String backgroundPath, Text text) {
		try {
			...
			/* Cria uma tela com as dimens�es especificadas para o background, e desenha a imagem do background. */
...
//			setTransitionImage(transitionImage, transition.getX(), transition.getY(), transition.getWidth(), transition.getHeight());
			...
			JOptionPane.showMessageDialog(null, "A imagem inserida n�o foi encontrada!");
		}
	}
